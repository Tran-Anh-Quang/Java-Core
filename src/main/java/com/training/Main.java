...
public class Main {
    ...
    private static void runArrayListExercise() {
...
//
//        System.out.println("after retain list 1 = " + list.retainAll(list1));
    }

    private static void runLinkedListExercise() {
...
//        System.out.println(linkedList.lastIndexOf("Bốn"));
    ...
    private static void runVectorExercise() {
...
//        System.out.println("after retain vector 1 = " + vector.retainAll(vector1));
    ...
    private static void runQueueExercise() {
